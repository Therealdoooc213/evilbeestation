...
GLOBAL_LIST_INIT(synthetic_first, world.file2list("strings/names/synthetic_first.txt"))
GLOBAL_LIST_INIT(synthetic_last, world.file2list("strings/names/synthetic_last.txt"))
