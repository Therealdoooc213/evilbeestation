...
/datum/dynamic_ruleset/latejoin/infiltrator
	...
	protected_roles = list(JOB_NAME_SECURITYOFFICER, JOB_NAME_DETECTIVE, JOB_NAME_WARDEN, JOB_NAME_HEADOFSECURITY, JOB_NAME_CAPTAIN, JOB_NAME_HEADOFPERSONNEL, JOB_NAME_LIASON)
...
/datum/dynamic_ruleset/latejoin/heretic_smuggler
	...
	protected_roles = list(JOB_NAME_SECURITYOFFICER, JOB_NAME_WARDEN, JOB_NAME_HEADOFPERSONNEL, JOB_NAME_DETECTIVE, JOB_NAME_HEADOFSECURITY, JOB_NAME_CAPTAIN, JOB_NAME_LIASON)
	restricted_roles = list(JOB_NAME_AI,JOB_NAME_CYBORG)
	required_candidates = 1
	weight = 4
	cost = 10
