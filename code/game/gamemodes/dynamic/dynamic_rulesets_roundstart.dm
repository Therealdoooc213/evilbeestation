...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list(JOB_NAME_SECURITYOFFICER, JOB_NAME_DETECTIVE, JOB_NAME_WARDEN, JOB_NAME_HEADOFSECURITY, JOB_NAME_CAPTAIN, JOB_NAME_LIAISON)
...
/datum/dynamic_ruleset/roundstart/changeling
	...
	protected_roles = list(JOB_NAME_SECURITYOFFICER, JOB_NAME_WARDEN, JOB_NAME_DETECTIVE, JOB_NAME_HEADOFSECURITY, JOB_NAME_CAPTAIN, JOB_NAME_LIAISON)
	restricted_roles = list(JOB_NAME_AI, JOB_NAME_CYBORG)
	required_candidates = 1
	weight = 3
	cost = 16
...
/datum/dynamic_ruleset/roundstart/incursion
	...
	protected_roles = list(JOB_NAME_SECURITYOFFICER, JOB_NAME_WARDEN, JOB_NAME_DETECTIVE,JOB_NAME_CAPTAIN, JOB_NAME_HEADOFPERSONNEL, JOB_NAME_HEADOFSECURITY, JOB_NAME_CHIEFENGINEER, JOB_NAME_RESEARCHDIRECTOR, JOB_NAME_CHIEFMEDICALOFFICER, JOB_NAME_LIAISON)
	restricted_roles = list(JOB_NAME_AI, JOB_NAME_CYBORG)
	required_candidates = 2
	weight = 3
	cost = 20
